...
# Cluster éditorial « diabète, glycémie et sports d’endurance ». Les pages
# répondent à des intentions différentes et renvoient vers un guide pivot au
# lieu de dupliquer un même protocole médical pour chaque distance.
_DT1_SPORT_SOURCES = [
    ["HAS — prescription d’activité physique et diabète de type 1", "https://www.has-sante.fr/upload/docs/application/pdf/2022-08/fiche_aps_dt1_vf.pdf"],
    ["ADA — activité physique, exercice et diabète", "https://diabetesjournals.org/care/article/39/11/2065/37249/Physical-Activity-Exercise-and-Diabetes-A-Position"],
    ["ADA/EASD — prise en charge du diabète de type 1 chez l’adulte", "https://diabetesjournals.org/care/article/44/11/2589/138492/The-Management-of-Type-1-Diabetes-in-Adults-A"],
]

SEO_GUIDES.update({
    "courir-10-km-diabete-type-1": {
        "title": "Courir un 10 km avec un diabète de type 1",
        "description": "Préparer un 10 km avec un diabète de type 1 : entraînement, glycémie, échauffement, glucides, matériel et débriefing de course.",
        "keywords": "courir 10 km diabète type 1, 10 km DT1, glycémie course 10 km, alimentation 10 km diabète",
        "kicker": "10 km avec un DT1",
        "intro": "Un 10 km est assez court pour être couru à forte intensité, mais assez long pour que l’échauffement, l’insuline active, le stress du départ et les conditions météo influencent la glycémie. Le bon plan est celui qui a déjà été répété à l’entraînement.",
        "medical_notice": "Ne copiez pas les doses ou corrections d’un autre coureur. Définissez avec votre équipe de diabétologie un protocole avant, pendant et après la course.",
        "sections": [
            ["Ce qui distingue le 10 km", "Un effort intense peut produire une réponse différente d’un footing : la glycémie peut baisser, rester stable ou monter transitoirement. Reproduisez l’heure de départ, l’échauffement et l’allure cible lors de séances tests."],
            ["Avant le départ", "Vérifiez la mesure, sa tendance et le contexte selon votre plan de soins. Gardez sur vous des glucides rapides, une identification médicale et le matériel de contrôle prévu, même si vous pensez courir moins d’une heure."],
            ["Pendant et juste après", "L’accès à l’écran doit rester simple et ne pas perturber la course. Après l’arrivée, conservez la surveillance prévue : la fin du chronomètre ne signifie pas la fin des effets de l’exercice."],
            ["Relire la course", "Comparez échauffement, allure, fréquence cardiaque, glycémie et récupération avec une séance spécifique. Une seule compétition ne suffit pas pour conclure sur une stratégie d’insuline ou de glucides."],
        ],
        "faq": [["Faut-il manger pendant un 10 km ?", "Cela dépend de la durée, de la glycémie, de sa tendance et de l’insuline active. Prévoyez dans tous les cas des glucides rapides conformément à votre protocole."], ["Pourquoi la glycémie peut-elle monter ?", "L’intensité et le stress peuvent favoriser une hausse transitoire. Son interprétation et une éventuelle correction doivent suivre vos consignes médicales."]],
        "sources": _DT1_SPORT_SOURCES,
        "related_slugs": ["glycemie-10-km", "insuline-et-sport-diabete-type-1", "quoi-manger-sport-diabete-type-1"],
    },
    "courir-semi-marathon-diabete-type-1": {
        "title": "Courir un semi-marathon avec un diabète de type 1",
        "description": "Préparer 21,1 km avec un diabète de type 1 : sorties spécifiques, suivi glycémique, ravitaillement, insuline et sécurité.",
        "keywords": "semi marathon diabète type 1, courir 21 km DT1, glycémie semi marathon, ravitaillement diabète course",
        "kicker": "21,1 km avec un DT1",
        "intro": "Le semi-marathon combine une intensité soutenue et une durée qui rend le ravitaillement plus important. La stratégie doit être testée sur des sorties spécifiques, avec le même horaire et un contexte aussi proche que possible de la course.",
        "medical_notice": "Les adaptations d’insuline et les seuils d’action sont individuels. Construisez-les avec votre équipe soignante à partir de vos propres séances.",
        "sections": [
            ["Construire des répétitions utiles", "Testez progressivement l’allure cible, le petit-déjeuner ou repas préalable, le délai avant l’effort, le matériel CGM et l’accès aux glucides. Notez l’insuline active et la tendance de départ."],
            ["Planifier les prises sans improviser", "Repérez les ravitaillements, ce que vous transportez et les moments où vous pourrez contrôler la tendance sans gêner les autres coureurs. Le plan nutritionnel sportif et le plan de prévention de l’hypoglycémie sont liés mais ne sont pas interchangeables."],
            ["Préparer un plan dégradé", "Prévoyez quoi faire si le capteur devient indisponible, si la météo change ou si l’allure ralentit. Un lecteur compatible, des glucides rapides et une personne informée peuvent faire partie du dispositif convenu."],
            ["Inclure la récupération", "L’historique doit dépasser la ligne d’arrivée. Documentez repas, mesures et symptômes durant la période post-effort définie avec vos soignants."],
        ],
        "faq": [["Quelle glycémie viser au départ ?", "Il existe des repères publiés, mais votre cible dépend de votre protocole, de la tendance, de l’insuline active et de l’effort prévu."], ["Peut-on tester le plan sur une course ?", "Mieux vaut valider ses éléments à l’entraînement et réserver la compétition à l’exécution d’un scénario déjà connu."]],
        "sources": _DT1_SPORT_SOURCES,
        "related_slugs": ["glycemie-semi-marathon", "quoi-manger-sport-diabete-type-1", "insuline-et-sport-diabete-type-1"],
    },
    "courir-marathon-diabete-type-1": {
        "title": "Courir un marathon avec un diabète de type 1",
        "description": "Préparer un marathon avec un diabète de type 1 : plan testé, glucides, hydratation, glycémie, insuline, matériel et récupération.",
        "keywords": "marathon diabète type 1, courir marathon DT1, insuline marathon, glycémie marathon, alimentation marathon diabète",
        "kicker": "42,195 km avec un DT1",
        "intro": "Sur marathon, la durée multiplie les interactions entre allure, glucides, hydratation, température, fatigue et insuline. La priorité n’est pas une formule universelle, mais un scénario personnel construit sur plusieurs sorties longues.",
        "medical_notice": "Un marathon ne doit pas servir de premier test thérapeutique. Faites valider votre stratégie d’insuline, de surveillance et de resucrage par l’équipe qui suit votre diabète.",
        "sections": [
            ["Répéter le scénario complet", "Utilisez les sorties longues pour tester heure de départ, repas, matériel, ravitaillements, accès au capteur et récupération. Ne changez qu’un petit nombre de variables à la fois afin de rendre la comparaison utile."],
            ["Séparer carburant et traitement", "Les glucides destinés à soutenir la performance et ceux prévus pour prévenir ou traiter une hypoglycémie n’ont pas exactement le même rôle. Consignez les deux pour interpréter correctement la course."],
            ["Prévoir autonomie et secours", "Emportez davantage que le besoin théorique, protégez le matériel de l’eau et des chocs, identifiez les postes de secours et partagez votre plan avec un proche. Anticipez également une panne de téléphone ou de capteur."],
            ["Surveiller l’après-marathon", "La fatigue, la recharge en glycogène et les changements de routine peuvent influencer les heures suivantes. Suivez la surveillance et les consignes post-effort personnalisées."],
        ],
        "faq": [["Combien de glucides prendre par heure ?", "La nutrition d’endurance fournit des plages sportives, mais avec un DT1 la quantité doit aussi être reliée à l’insuline active, aux mesures et au protocole médical."], ["Peut-on se fier uniquement au capteur ?", "Le CGM apporte une tendance mais peut présenter un décalage lors de variations rapides. Suivez les règles de confirmation de votre dispositif et votre plan de soins."]],
        "sources": _DT1_SPORT_SOURCES,
        "related_slugs": ["glycemie-marathon", "quoi-manger-sport-diabete-type-1", "enregistrer-activite-et-glycemie"],
    },
    "utmb-diabete-type-1": {
        "title": "Faire l’UTMB avec un diabète de type 1 : préparer son ultra-trail",
        "description": "Préparer l’UTMB Mont-Blanc avec un diabète de type 1 : autonomie, glycémie, insuline, alimentation, nuit, assistance et plan de secours.",
        "keywords": "UTMB diabète type 1, ultra trail DT1, glycémie UTMB, insuline ultra trail, alimentation UTMB diabète",
        "kicker": "Ultra-trail et diabète de type 1",
        "intro": "L’UTMB ajoute à l’effort long le froid, la chaleur, l’altitude, la nuit, les barrières horaires et l’isolement entre deux points d’assistance. La stratégie glycémique doit faire partie du plan de course et de ses scénarios de secours.",
        "medical_notice": "Un ultra avec DT1 exige une préparation médicale individualisée. Discutez complications éventuelles, insuline, cétones, hypoglycémies, sommeil et conduite d’urgence avec votre équipe bien avant l’épreuve.",
        "sections": [
            ["Découper par bases de vie et ravitaillements", "Pour chaque tronçon, estimez durée, météo probable, autonomie alimentaire, batterie et accès au matériel. Une distance courte sur la carte peut représenter plusieurs heures en montagne."],
            ["Tester la nuit et les changements de température", "Les alarmes, gants, vêtements, humidité et fatigue modifient l’utilisation réelle du matériel. Les répétitions de nuit servent à vérifier que glucose, glucides et secours restent accessibles."],
            ["Organiser l’assistance", "Préparez des sacs identifiés, une liste de contrôle et des consignes simples pour l’assistance. Celle-ci doit connaître votre plan, sans improviser de décision thérapeutique à votre place."],
            ["Prévoir les pannes", "Capteur arraché, téléphone déchargé, réseau absent ou abandon loin de l’assistance doivent avoir une réponse logistique préparée. Le règlement et les consignes de l’organisation restent la référence."],
        ],
        "faq": [["La couverture réseau suffit-elle pour afficher la glycémie ?", "Non. Certaines solutions de montre dépendent du téléphone, d’Internet ou du partage cloud. Testez exactement votre chaîne et prévoyez la solution de contrôle recommandée en cas de panne."], ["Faut-il changer l’insuline pour la nuit ?", "Toute adaptation dépend de votre traitement et de votre historique ; elle doit être établie avec votre équipe de diabétologie."]],
        "sources": _DT1_SPORT_SOURCES,
        "course_ids": ["utmb-2026"],
        "related_slugs": ["trail-diabete-type-1", "afficher-glycemie-sur-montre", "utmb-mont-blanc"],
    },
    "velo-diabete-type-1": {
        "title": "Faire du vélo avec un diabète de type 1",
        "description": "Vélo de route, gravel ou VTT avec un diabète de type 1 : glycémie, glucides accessibles, insuline, compteur, autonomie et sécurité.",
        "keywords": "vélo diabète type 1, cyclisme DT1, glycémie vélo, insuline cyclisme, capteur glucose compteur Garmin",
        "kicker": "Cyclisme avec un DT1",
        "intro": "Le vélo permet d’emporter du matériel, mais les longues sorties, les côtes et l’éloignement compliquent la gestion d’un imprévu. L’objectif est de rendre le contrôle et les glucides accessibles sans manipuler un écran en roulant.",
        "medical_notice": "Arrêtez-vous dans un endroit sûr pour vérifier une valeur ou appliquer votre protocole. Toute adaptation d’insuline doit être définie avec vos soignants.",
        "sections": [
            ["Distinguer endurance et changements de rythme", "Une sortie régulière, des relais appuyés, des côtes ou une course ne provoquent pas nécessairement la même réponse. Classez vos activités par format pour construire des repères."],
            ["Rendre l’essentiel accessible", "Répartissez les glucides rapides entre poches et sacoche, protégez le matériel et prévoyez eau, batterie, identification et moyen de retour. Ne placez pas toute la réserve au même endroit."],
            ["Afficher sans se distraire", "Un champ de données compatible peut montrer valeur et tendance sur certains compteurs ou montres. Il s’agit d’un affichage secondaire : configurez les alarmes officielles et arrêtez-vous avant toute action complexe."],
            ["Synchroniser la sortie", "Enregistrez le vélo sur la montre ou le compteur, synchronisez vers Strava, puis rapprochez séparément la source CGM. Vérifiez les heures si les courbes semblent décalées."],
        ],
        "faq": [["Peut-on afficher Dexcom sur un compteur Garmin ?", "Dexcom propose un champ de données Connect IQ pour des appareils compatibles, selon le pays, le capteur et la configuration pris en charge."], ["Et pour un home trainer ?", "L’activité peut être synchronisée depuis la plateforme utilisée ; le rapprochement avec le CGM repose toujours sur les horodatages."]],
        "sources": _DT1_SPORT_SOURCES + [["Dexcom — intégration avec Garmin", "https://www.dexcom.com/en-GB/integrations-and-connectivity/lifestyle-devices/garmin"], ["Strava — connecter Garmin et Strava", "https://support.strava.com/hc/fr/articles/216918057-Garmin-et-Strava"]],
        "related_slugs": ["glycemie-velo", "afficher-glycemie-sur-montre", "enregistrer-activite-et-glycemie"],
    },
    "quoi-manger-sport-diabete-type-1": {
        "title": "Que manger avant, pendant et après le sport avec un diabète de type 1 ?",
        "description": "Alimentation et diabète de type 1 pendant le sport : distinguer repas, carburant d’endurance et glucides rapides, puis tester un plan personnel.",
        "keywords": "quoi manger sport diabète type 1, alimentation DT1 course, glucides effort diabète, ravitaillement diabète sport",
        "kicker": "Alimentation, effort et DT1",
        "intro": "Il n’existe pas un menu unique pour tous les sports ni toutes les personnes avec un DT1. Il faut distinguer le repas habituel, les glucides destinés à soutenir un effort long et la réserve de glucides rapides prévue dans le protocole de prévention ou de traitement de l’hypoglycémie.",
        "medical_notice": "Les quantités et leur relation avec l’insuline sont individuelles. Construisez ce plan avec un diabétologue ou diététicien formé au sport et au diabète.",
        "sections": [
            ["Avant : choisir un contexte reproductible", "Testez un repas connu, sa quantité de glucides, son délai de digestion et l’insuline active sur une séance comparable. Les protéines, lipides et fibres peuvent aussi modifier la digestion."],
            ["Pendant : raisonner par fonction", "D’un côté, planifiez le carburant nécessaire à la durée et à l’intensité ; de l’autre, gardez une réserve immédiatement accessible pour le protocole d’hypoglycémie. Notez ce qui a réellement été consommé."],
            ["Après : récupérer et continuer à observer", "Le repas post-effort s’inscrit dans la récupération, mais l’exercice peut encore influencer la glycémie. Appliquez les consignes personnalisées de surveillance et d’insuline."],
            ["Tester la tolérance", "Gels, boissons, compotes, barres ou aliments solides diffèrent par leur concentration, texture et vitesse de digestion. Progressez à l’entraînement et documentez les symptômes digestifs."],
        ],
        "faq": [["Existe-t-il un nombre de grammes par heure avec un DT1 ?", "Des plages existent en nutrition sportive, mais le besoin lié à l’effort et celui lié à la prévention d’une hypo doivent être individualisés avec l’insuline active et les mesures."], ["Un gel est-il toujours un resucrage ?", "Un gel contient des glucides, mais son usage, sa composition et sa vitesse d’action comptent. Suivez les produits et quantités prévus dans votre protocole."]],
        "sources": _DT1_SPORT_SOURCES,
        "related_slugs": ["glucides-par-heure", "types-glucides-endurance", "insuline-et-sport-diabete-type-1"],
    },
    "insuline-et-sport-diabete-type-1": {
        "title": "Insuline et sport avec un diabète de type 1 : construire un plan personnel",
        "description": "Comprendre insuline active, basal, bolus, pompe et effort avec un diabète de type 1, sans appliquer une dose universelle.",
        "keywords": "insuline sport diabète type 1, réduire insuline avant sport, pompe insuline course, bolus exercice DT1",
        "kicker": "Traitement et activité physique",
        "intro": "L’effet d’une séance dépend autant de l’insuline présente que de sa durée et de son intensité. Les publications proposent des points de départ cliniques, mais ils ne deviennent sûrs qu’après individualisation avec l’équipe soignante et essais contrôlés.",
        "medical_notice": "Cette page n’indique volontairement aucune dose à appliquer. Ne réduisez, ne suspendez et ne corrigez jamais l’insuline à partir d’un guide SEO.",
        "sections": [
            ["Comprendre l’insuline active", "Un exercice commencé peu après un repas et son bolus ne ressemble pas au même exercice réalisé avec peu d’insuline prandiale active. Notez le délai, le type de repas et le mode d’administration."],
            ["Basal, bolus et pompe ne se copient pas", "Les possibilités et délais diffèrent entre injections multiples, pompe classique et boucle hybride. Une suspension tardive n’a pas le même effet qu’une stratégie anticipée, et une absence excessive d’insuline peut présenter un risque."],
            ["Type d’effort et réponse", "L’endurance modérée favorise souvent une baisse, tandis qu’un effort intense peut être plus stable ou entraîner une hausse transitoire. La variabilité personnelle impose de tester chaque famille de séance."],
            ["Créer une fiche avec les soignants", "Pour chaque format, consignez horaire, repas, insuline active, réglage utilisé, glycémie et flèches, glucides, effort et période post-exercice. Cette fiche rend les ajustements médicaux plus concrets."],
        ],
        "faq": [["De combien faut-il réduire l’insuline ?", "Impossible de répondre sans connaître traitement, horaire, intensité, durée et historique. Les tableaux publiés sont des points de départ à utiliser avec un professionnel."], ["Faut-il couper sa pompe ?", "Pas automatiquement. Le risque d’hypoglycémie doit être mis en balance avec celui d’un manque d’insuline ; appliquez le plan défini pour votre dispositif."]],
        "sources": _DT1_SPORT_SOURCES,
        "related_slugs": ["sport-diabete-type-1", "hypoglycemie-pendant-sport", "hyperglycemie-et-sport"],
    },
    "glycemie-non-diabetique-sport-endurance": {
        "title": "Glycémie d’un non-diabétique pendant un 10 km, marathon, trail ou vélo",
        "description": "Comprendre la glycémie chez un sportif non diabétique pendant un 10 km, semi, marathon, trail, ultra ou sortie vélo et les limites d’un CGM.",
        "keywords": "glycémie non diabétique sport, glycémie normale marathon, glucose trail non diabétique, capteur glycémie sportif",
        "kicker": "Physiologie sans diabète",
        "intro": "Chez une personne sans diabète, la glycémie est régulée dynamiquement pendant l’effort par le foie, les muscles et les hormones. Un CGM peut montrer des variations, mais une courbe isolée ne mesure ni la performance, ni les réserves de glycogène, ni la qualité d’une stratégie nutritionnelle.",
        "medical_notice": "Un capteur grand public ne permet pas de diagnostiquer un diabète. Des valeurs répétées inattendues ou des symptômes doivent être discutés avec un professionnel de santé.",
        "sections": [
            ["10 km : intensité et stress", "Un effort bref et intense peut s’accompagner d’une hausse transitoire liée à la mobilisation de glucose. Cela ne signifie pas automatiquement qu’un apport était excessif."],
            ["Semi et marathon : durée et ravitaillement", "À mesure que la durée augmente, apports, réserves, allure et température interagissent. La glycémie seule ne révèle pas combien de glycogène reste disponible."],
            ["Trail, ultra et vélo : fortes variations de contexte", "Montées, descentes, arrêts, nuit et prises alimentaires rendent la courbe plus difficile à attribuer à une cause unique. Reliez chaque mesure à l’intensité et au moment des apports."],
            ["Ce que le CGM ne dit pas", "Le glucose interstitiel peut être décalé lors des variations rapides et les capteurs ne sont pas tous validés pour guider la nutrition chez les personnes sans diabète. Comparez des séances similaires sans surinterpréter chaque pic."],
        ],
        "faq": [["Quelle est la glycémie normale pendant un marathon ?", "Il n’existe pas une courbe idéale universelle de compétition. Une valeur doit être interprétée selon la méthode de mesure, les symptômes et le contexte clinique."], ["Un CGM permet-il de savoir quand prendre un gel ?", "Pas à lui seul. La stratégie dépend surtout de la durée, de l’intensité, des apports planifiés et de la tolérance."]],
        "sources": [["NIDDK — rôle de l’insuline, du glucagon et du pancréas", "https://www.niddk.nih.gov/-/media/Files/Diabetes/Causes_of_Diabetes_508.pdf"], ["Revue — utilisation du CGM chez les personnes sans diabète", "https://pubmed.ncbi.nlm.nih.gov/36996559/"], ["Consensus international — métriques du CGM", "https://diabetesjournals.org/care/article/42/8/1593/36184/Clinical-Targets-for-Continuous-Glucose-Monitoring"]],
        "related_slugs": ["variations-glycemie-pendant-effort", "insuline-pancreas-et-sport", "glucides-par-heure"],
        "history_cta": True,
    },
    "afficher-glycemie-sur-montre": {
        "title": "Comment afficher sa glycémie sur une montre pendant le sport ?",
        "description": "Afficher sa glycémie sur Garmin, Apple Watch ou un compteur vélo : compatibilité CGM, application, téléphone, réseau, alarmes et limites.",
        "keywords": "glycémie sur montre Garmin, Dexcom Garmin, Libre montre, glycémie Apple Watch, glucose compteur vélo",
        "kicker": "CGM, montre et compteur vélo",
        "intro": "L’affichage dépend de quatre éléments : le capteur, son application officielle, la montre ou le compteur compatible, et parfois le téléphone ou Internet. Il faut vérifier toute la chaîne avant de compter dessus pendant une course.",
        "medical_notice": "Une montre est généralement un affichage secondaire. Les décisions de traitement doivent suivre les instructions du système CGM et le protocole de soins, notamment lorsqu’une valeur ne correspond pas aux symptômes.",
        "sections": [
            ["Garmin et Dexcom", "Sur les appareils et territoires compatibles, installez depuis Connect IQ le widget pour consulter la glycémie hors activité et le champ de données pour l’afficher pendant une activité. Connectez le compte requis, ajoutez le champ à l’écran du profil sportif, puis testez téléphone, données mobiles et actualisation."],
            ["Apple Watch et montres compatibles", "Utilisez en priorité l’application et la documentation officielles de votre CGM. Selon le modèle et le pays, la montre peut recevoir une application dédiée ou seulement refléter les notifications du téléphone."],
            ["FreeStyle Libre", "Abbott propose un affichage montre sur certaines combinaisons de capteur, application, pays et système. Vérifiez la liste officielle : certaines configurations nécessitent que téléphone, capteur et montre restent à portée."],
            ["Test avant le départ", "Contrôlez l’âge de la mesure, la flèche, les unités, les alarmes, la batterie et le fonctionnement écran verrouillé. Préparez aussi la méthode de contrôle de secours prévue par le fabricant."],
        ],
        "faq": [["La montre reçoit-elle directement le capteur ?", "Cela dépend du capteur et de la plateforme. Beaucoup de configurations passent par le téléphone ou le cloud ; ne supposez pas qu’elles fonctionnent sans réseau."], ["Peut-on enregistrer la glycémie dans le fichier FIT ?", "Certains champs tiers le proposent, mais ce n’est ni universel ni nécessaire pour l’analyse : une plateforme peut rapprocher séparément activité et CGM par l’heure."]],
        "sources": [["Dexcom — intégration avec Garmin", "https://www.dexcom.com/en-GB/integrations-and-connectivity/lifestyle-devices/garmin"], ["Garmin Connect IQ — champ de données Dexcom", "https://apps.garmin.com/apps/ba75d9d1-1561-4d10-a346-43a2a179fa95"], ["Abbott — application Libre pour montre", "https://www.support.freestyle.abbott/hc/en-us/articles/41609521042833-What-is-the-Libre-watch-app"]],
        "related_slugs": ["enregistrer-activite-et-glycemie", "synchroniser-strava-glycemie", "glycemie-velo"],
    },
    "enregistrer-activite-et-glycemie": {
        "title": "Comment enregistrer une activité sportive et sa glycémie ?",
        "description": "Enregistrer course, trail ou vélo avec une montre, synchroniser l’activité vers Strava et rapprocher séparément les données CGM.",
        "keywords": "enregistrer activité glycémie, activité Strava CGM, synchroniser montre glycémie, importer FIT glucose",
        "kicker": "Activité GPS et données CGM",
        "intro": "Le plus fiable est de conserver deux sources originales : la montre ou le compteur enregistre l’activité, tandis que l’application CGM conserve la glycémie. Running Data Plan les rapproche ensuite par leurs horodatages.",
        "medical_notice": "L’enregistrement rétrospectif ne remplace ni l’application officielle, ni ses alarmes, ni la surveillance prévue par votre protocole médical.",
        "sections": [
            ["1. Enregistrer l’activité", "Démarrez le bon profil sportif sur Garmin, COROS, Polar, Suunto, Wahoo, Apple Watch ou Strava. Attendez le GPS si nécessaire, puis enregistrez et sauvegardez à l’arrivée."],
            ["2. Envoyer vers Strava", "Connectez le compte du fabricant à Strava pour une synchronisation automatique, ou importez un fichier FIT, TCX ou GPX compatible. Évitez d’enregistrer simultanément sur plusieurs appareils si cela crée des doublons."],
            ["3. Connecter la source CGM", "Autorisez séparément une source prise en charge, par exemple Dexcom Share, Nightscout, LibreLinkUp ou CareLink selon la configuration du service. Vérifiez le fuseau horaire et la période disponible."],
            ["4. Vérifier le rapprochement", "Contrôlez début, fin, pauses et couverture des mesures. Un décalage constant suggère souvent un problème d’heure ou de fuseau ; une zone vide peut venir d’une interruption de source."],
        ],
        "faq": [["Strava enregistre-t-il la glycémie ?", "Non. Strava fournit principalement l’activité ; la glycémie vient d’une source CGM distincte puis les chronologies sont rapprochées."], ["Faut-il afficher le glucose sur la montre pour l’analyser ?", "Non. L’affichage pendant l’effort et l’analyse après l’effort sont deux fonctions distinctes."]],
        "sources": [["Strava — transférer ses activités vers Strava", "https://support.strava.com/hc/fr/articles/223297187-Comment-t%C3%A9l%C3%A9charger-vos-activit%C3%A9s-vers-Strava"], ["Strava — application Apple Watch", "https://support.strava.com/hc/fr/articles/115000161184-Application-Strava-pour-Apple-Watch"]],
        "related_slugs": ["synchroniser-strava-glycemie", "afficher-glycemie-sur-montre", "glycemie-running"],
        "tracking_cta": True,
    },
    "synchroniser-strava-glycemie": {
        "title": "Comment synchroniser Strava et sa glycémie CGM ?",
        "description": "Comprendre la synchronisation entre une activité Strava et les mesures Dexcom, LibreLinkUp, Nightscout ou CareLink pour analyser son sport.",
        "keywords": "synchroniser Strava glycémie, connecter Dexcom Strava, Libre Strava glucose, CGM activité sportive",
        "kicker": "Strava + capteur de glucose",
        "intro": "Strava et le capteur ne transportent pas les mêmes données. L’activité apporte temps, GPS, allure, altitude et cardio ; la source CGM apporte les mesures de glucose. Leur point commun est l’heure.",
        "medical_notice": "La synchronisation sert à l’analyse sportive. Elle ne transforme pas Strava ou Running Data Plan en système médical d’alarme.",
        "sections": [
            ["Connecter Strava", "Autorisez l’accès à vos activités depuis votre compte. Une activité enregistrée par la montre arrive généralement après la synchronisation du fabricant vers Strava."],
            ["Choisir une source CGM", "Connectez uniquement le fournisseur correspondant à votre configuration : Dexcom Share, LibreLinkUp, Nightscout ou CareLink par exemple. Les disponibilités et délais diffèrent selon les services."],
            ["Faire correspondre les heures", "La plateforme place les mesures dans l’intervalle temporel de l’activité, puis peut les relier à la distance et au profil. Les pauses et changements de fuseau doivent être conservés correctement."],
            ["Protéger ses données", "La glycémie est une donnée de santé. Utilisez des connexions autorisées, vérifiez les paramètres de partage et évitez de publier une courbe identifiable sans l’avoir décidé."],
        ],
        "faq": [["Peut-on mettre la glycémie dans la description Strava ?", "C’est techniquement possible manuellement, mais une courbe médicale détaillée peut révéler des données sensibles. Une analyse privée séparée est souvent plus adaptée."], ["Pourquoi manque-t-il des points ?", "La source peut avoir un délai, une interruption, une période d’accès limitée ou un problème d’horodatage."]],
        "sources": [["Strava — transférer ses activités vers Strava", "https://support.strava.com/hc/fr/articles/223297187-Comment-t%C3%A9l%C3%A9charger-vos-activit%C3%A9s-vers-Strava"], ["Dexcom — partage des données CGM", "https://www.dexcom.com/en-gb/dexcom-follow"]],
        "related_slugs": ["enregistrer-activite-et-glycemie", "afficher-glycemie-sur-montre", "trail-et-glycemie"],
        "tracking_cta": True,
    },
})
