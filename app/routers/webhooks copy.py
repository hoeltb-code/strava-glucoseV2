...
#from app.main import enrich_activity  # temporaire, on pourra le déplacer plus tard
...
async def webhook_event(body: dict = Body(...)):
    """Réception des événements Strava (create/update activité)."""
    ...
    # 🧩 C’est ICI qu’on fait l’import local, juste avant l’appel
    try:
        from app.main import enrich_activity  # import déplacé ici pour éviter l'import circulaire
